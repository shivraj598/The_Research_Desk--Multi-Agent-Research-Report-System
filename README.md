...
| Dark Mode | Light Mode | Research Output |
|---|---|---|
| ![Dark mode interface](sample_pic/image_darkmode.png) | ![Light mode interface](sample_pic/image_white.png) | ![Research output example](sample_pic/output1.png) |
